...
class PaintEvent extends SingleChildRenderObjectWidget {
  ...
  const PaintEvent({Key key, this.paintBefore, this.paintAfter, Widget child})
      : super(key: key, child: child);
  @override
  PaintEventProxyBox createRenderObject(BuildContext context) {
    return PaintEventProxyBox(paintAfter: paintAfter, paintBefore: paintBefore);
  }

  @override
  void updateRenderObject(
      BuildContext context, PaintEventProxyBox renderObject) {
    renderObject
...
class PaintEventProxyBox extends RenderProxyBox {
  ...
  PaintEventProxyBox({RenderBox child, this.paintBefore, this.paintAfter})
      : super(child);
